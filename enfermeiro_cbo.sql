-- View: pmaq."ENFERMEIRO_CBO"

DROP VIEW if exists pmaq."ENFERMEIRO_CBO";

CREATE OR REPLACE VIEW pmaq."ENFERMEIRO_CBO" AS 
 SELECT tb_dim_municipio.no_municipio,
    ...
    ( SELECT count(
          ...
          WHERE c.nu_cbo::text = cc.nu_cbo::text AND t.nu_ano = tt.nu_ano AND u.nu_cnes::text = uu.nu_cnes::text) AS cit_janeiro,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_proced_atend_proced
             ...
             JOIN tb_dim_unidade_saude u ON tb_fat_proced_atend_proced.co_dim_unidade_saude = u.co_seq_dim_unidade_saude
             JOIN tb_dim_cbo c ON tb_fat_proced_atend_proced.co_dim_cbo = c.co_seq_dim_cbo
          WHERE c.nu_cbo::text = cc.nu_cbo::text AND t.nu_ano = tt.nu_ano AND u.nu_cnes::text = uu.nu_cnes::text) AS cit_fev,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_proced_atend_proced
             ...
             JOIN tb_dim_unidade_saude u ON tb_fat_proced_atend_proced.co_dim_unidade_saude = u.co_seq_dim_unidade_saude
             JOIN tb_dim_cbo c ON tb_fat_proced_atend_proced.co_dim_cbo = c.co_seq_dim_cbo
          WHERE c.nu_cbo::text = cc.nu_cbo::text AND t.nu_ano = tt.nu_ano AND u.nu_cnes::text = uu.nu_cnes::text) AS cit_marc,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_proced_atend_proced
             ...
             JOIN tb_dim_unidade_saude u ON tb_fat_proced_atend_proced.co_dim_unidade_saude = u.co_seq_dim_unidade_saude
             JOIN tb_dim_cbo c ON tb_fat_proced_atend_proced.co_dim_cbo = c.co_seq_dim_cbo
          WHERE c.nu_cbo::text = cc.nu_cbo::text AND t.nu_ano = tt.nu_ano AND u.nu_cnes::text = uu.nu_cnes::text) AS cit_abril,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_proced_atend_proced
             ...
             JOIN tb_dim_unidade_saude u ON tb_fat_proced_atend_proced.co_dim_unidade_saude = u.co_seq_dim_unidade_saude
             JOIN tb_dim_cbo c ON tb_fat_proced_atend_proced.co_dim_cbo = c.co_seq_dim_cbo
          WHERE c.nu_cbo::text = cc.nu_cbo::text AND t.nu_ano = tt.nu_ano AND u.nu_cnes::text = uu.nu_cnes::text) AS cit_maio,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_proced_atend_proced
             ...
             JOIN tb_dim_unidade_saude u ON tb_fat_proced_atend_proced.co_dim_unidade_saude = u.co_seq_dim_unidade_saude
             JOIN tb_dim_cbo c ON tb_fat_proced_atend_proced.co_dim_cbo = c.co_seq_dim_cbo
          WHERE c.nu_cbo::text = cc.nu_cbo::text AND t.nu_ano = tt.nu_ano AND u.nu_cnes::text = uu.nu_cnes::text) AS cit_junho,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_proced_atend_proced
             ...
             JOIN tb_dim_unidade_saude u ON tb_fat_proced_atend_proced.co_dim_unidade_saude = u.co_seq_dim_unidade_saude
             JOIN tb_dim_cbo c ON tb_fat_proced_atend_proced.co_dim_cbo = c.co_seq_dim_cbo
          WHERE c.nu_cbo::text = cc.nu_cbo::text AND t.nu_ano = tt.nu_ano AND u.nu_cnes::text = uu.nu_cnes::text) AS cit_julho,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_proced_atend_proced
             ...
             JOIN tb_dim_unidade_saude u ON tb_fat_proced_atend_proced.co_dim_unidade_saude = u.co_seq_dim_unidade_saude
             JOIN tb_dim_cbo c ON tb_fat_proced_atend_proced.co_dim_cbo = c.co_seq_dim_cbo
          WHERE c.nu_cbo::text = cc.nu_cbo::text AND t.nu_ano = tt.nu_ano AND u.nu_cnes::text = uu.nu_cnes::text) AS cit_agosto,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_proced_atend_proced
             ...
             JOIN tb_dim_unidade_saude u ON tb_fat_proced_atend_proced.co_dim_unidade_saude = u.co_seq_dim_unidade_saude
             JOIN tb_dim_cbo c ON tb_fat_proced_atend_proced.co_dim_cbo = c.co_seq_dim_cbo
          WHERE c.nu_cbo::text = cc.nu_cbo::text AND t.nu_ano = tt.nu_ano AND u.nu_cnes::text = uu.nu_cnes::text) AS cit_setembro,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_proced_atend_proced
             ...
             JOIN tb_dim_unidade_saude u ON tb_fat_proced_atend_proced.co_dim_unidade_saude = u.co_seq_dim_unidade_saude
             JOIN tb_dim_cbo c ON tb_fat_proced_atend_proced.co_dim_cbo = c.co_seq_dim_cbo
          WHERE c.nu_cbo::text = cc.nu_cbo::text AND t.nu_ano = tt.nu_ano AND u.nu_cnes::text = uu.nu_cnes::text) AS cit_outubro,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_proced_atend_proced
             ...
             JOIN tb_dim_unidade_saude u ON tb_fat_proced_atend_proced.co_dim_unidade_saude = u.co_seq_dim_unidade_saude
             JOIN tb_dim_cbo c ON tb_fat_proced_atend_proced.co_dim_cbo = c.co_seq_dim_cbo
          WHERE c.nu_cbo::text = cc.nu_cbo::text AND t.nu_ano = tt.nu_ano AND u.nu_cnes::text = uu.nu_cnes::text) AS cit_novembro,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_proced_atend_proced
             ...
             JOIN tb_dim_unidade_saude u ON tb_fat_proced_atend_proced.co_dim_unidade_saude = u.co_seq_dim_unidade_saude
             JOIN tb_dim_cbo c ON tb_fat_proced_atend_proced.co_dim_cbo = c.co_seq_dim_cbo
          WHERE c.nu_cbo::text = cc.nu_cbo::text AND t.nu_ano = tt.nu_ano AND u.nu_cnes::text = uu.nu_cnes::text) AS cit_dezembro,
    count(
        CASE
...
ALTER TABLE pmaq."ENFERMEIRO_CBO"
  OWNER TO postgres;
GRANT ALL ON TABLE pmaq."ENFERMEIRO_CBO" TO postgres;
GRANT ALL ON TABLE pmaq."ENFERMEIRO_CBO" TO pmaq;
