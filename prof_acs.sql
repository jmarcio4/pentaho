...
DROP VIEW if exists  pmaq."PROF_ACS";

CREATE OR REPLACE VIEW pmaq."PROF_ACS" AS 
 SELECT tb_unidade_saude.nu_cnes,
  ...
  WHERE tb_lotacao.st_ativo = 1 AND tb_lotacao.st_importada = 1 AND tb_cbo.co_cbo_2002::text = '515105'::text
...
ALTER TABLE pmaq."PROF_ACS"
  OWNER TO postgres;
GRANT ALL ON TABLE pmaq."PROF_ACS" TO postgres;
GRANT ALL ON TABLE pmaq."PROF_ACS" TO pmaq;
