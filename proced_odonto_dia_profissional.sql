-- View: pmaq."PROCED_ODONTO_DIA_PROFISSIONAL"

DROP VIEW if exists pmaq."PROCED_ODONTO_DIA_PROFISSIONAL";

CREATE OR REPLACE VIEW pmaq."PROCED_ODONTO_DIA_PROFISSIONAL" AS 
...
ALTER TABLE pmaq."PROCED_ODONTO_DIA_PROFISSIONAL"
  OWNER TO postgres;
GRANT ALL ON TABLE pmaq."PROCED_ODONTO_DIA_PROFISSIONAL" TO postgres;
GRANT ALL ON TABLE pmaq."PROCED_ODONTO_DIA_PROFISSIONAL" TO pmaq;
