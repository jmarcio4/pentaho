-- View: pmaq."CBO_PROCED_ODONTO_UNIDADE"

DROP VIEW if exists pmaq."CBO_PROCED_ODONTO_UNIDADE";

CREATE OR REPLACE VIEW pmaq."CBO_PROCED_ODONTO_UNIDADE" AS 
...
ALTER TABLE pmaq."CBO_PROCED_ODONTO_UNIDADE"
  OWNER TO postgres;
GRANT ALL ON TABLE pmaq."CBO_PROCED_ODONTO_UNIDADE" TO postgres;
GRANT ALL ON TABLE pmaq."CBO_PROCED_ODONTO_UNIDADE" TO pmaq;
