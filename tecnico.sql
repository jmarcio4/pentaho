...
DROP VIEW if exists pmaq."TECNICO";

CREATE OR REPLACE VIEW pmaq."TECNICO" AS 
 SELECT tb_dim_municipio.no_municipio,
    ...
    ( SELECT count(
           ...
           FROM tb_cds_tipo_ativ_col
             ...
             JOIN tb_dim_unidade_saude u ON p.nu_cnes::text = u.nu_cnes::text
             JOIN tb_dim_cbo c ON p.nu_cbo_2002::text = c.nu_cbo::text
          WHERE to_char(tb_cds_ficha_ativ_col.dt_ativ_col, 'YYYY'::text)::integer = tt.nu_ano AND p.nu_cns::text = pp.nu_cns::text AND u.nu_cnes::text = uu.nu_cnes::text) AS reuni_mar,
    ( SELECT count(
                CASE
           ...
           FROM tb_cds_tipo_ativ_col
             ...
             JOIN tb_dim_unidade_saude u ON p.nu_cnes::text = u.nu_cnes::text
             JOIN tb_dim_cbo c ON p.nu_cbo_2002::text = c.nu_cbo::text
          WHERE to_char(tb_cds_ficha_ativ_col.dt_ativ_col, 'YYYY'::text)::integer = tt.nu_ano AND p.nu_cns::text = pp.nu_cns::text AND u.nu_cnes::text = uu.nu_cnes::text) AS reuni_abr,
    ( SELECT count(
                CASE
           ...
           FROM tb_cds_tipo_ativ_col
             ...
             JOIN tb_dim_unidade_saude u ON p.nu_cnes::text = u.nu_cnes::text
             JOIN tb_dim_cbo c ON p.nu_cbo_2002::text = c.nu_cbo::text
          WHERE to_char(tb_cds_ficha_ativ_col.dt_ativ_col, 'YYYY'::text)::integer = tt.nu_ano AND p.nu_cns::text = pp.nu_cns::text AND u.nu_cnes::text = uu.nu_cnes::text) AS reuni_mai,
    ( SELECT count(
                CASE
    ...
    ( SELECT count(
           ...
           FROM tb_cds_tipo_ativ_col
             ...
             JOIN tb_dim_unidade_saude u ON p.nu_cnes::text = u.nu_cnes::text
             JOIN tb_dim_cbo c ON p.nu_cbo_2002::text = c.nu_cbo::text
          WHERE to_char(tb_cds_ficha_ativ_col.dt_ativ_col, 'YYYY'::text)::integer = tt.nu_ano AND p.nu_cns::text = pp.nu_cns::text AND u.nu_cnes::text = uu.nu_cnes::text) AS reuni_jul,
    ( SELECT count(
                CASE
           ...
           FROM tb_cds_tipo_ativ_col
             ...
             JOIN tb_dim_unidade_saude u ON p.nu_cnes::text = u.nu_cnes::text
             JOIN tb_dim_cbo c ON p.nu_cbo_2002::text = c.nu_cbo::text
          WHERE to_char(tb_cds_ficha_ativ_col.dt_ativ_col, 'YYYY'::text)::integer = tt.nu_ano AND p.nu_cns::text = pp.nu_cns::text AND u.nu_cnes::text = uu.nu_cnes::text) AS reuni_ago,
    ( SELECT count(
                CASE
           ...
           FROM tb_cds_tipo_ativ_col
             ...
             JOIN tb_dim_unidade_saude u ON p.nu_cnes::text = u.nu_cnes::text
             JOIN tb_dim_cbo c ON p.nu_cbo_2002::text = c.nu_cbo::text
          WHERE to_char(tb_cds_ficha_ativ_col.dt_ativ_col, 'YYYY'::text)::integer = tt.nu_ano AND p.nu_cns::text = pp.nu_cns::text AND u.nu_cnes::text = uu.nu_cnes::text) AS reuni_set,
    ( SELECT count(
                CASE
           ...
           FROM tb_cds_tipo_ativ_col
             ...
             JOIN tb_dim_unidade_saude u ON p.nu_cnes::text = u.nu_cnes::text
             JOIN tb_dim_cbo c ON p.nu_cbo_2002::text = c.nu_cbo::text
          WHERE to_char(tb_cds_ficha_ativ_col.dt_ativ_col, 'YYYY'::text)::integer = tt.nu_ano AND p.nu_cns::text = pp.nu_cns::text AND u.nu_cnes::text = uu.nu_cnes::text) AS reuni_out,
    ( SELECT count(
                CASE
    ...
    ( SELECT count(
           ...
           FROM tb_fat_proced_atend
             ...
             JOIN tb_dim_profissional p ON tb_fat_proced_atend.co_dim_profissional = p.co_seq_dim_profissional
          ...
          WHERE t.nu_ano = tt.nu_ano AND p.nu_cns::text = pp.nu_cns::text AND u.nu_cnes::text = uu.nu_cnes::text) AS domicilio_jan,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_proced_atend
             ...
             JOIN tb_dim_profissional p ON tb_fat_proced_atend.co_dim_profissional = p.co_seq_dim_profissional
             JOIN tb_dim_local_atendimento ON tb_fat_proced_atend.co_dim_local_atendimento = tb_dim_local_atendimento.co_seq_dim_local_atendimento
          WHERE t.nu_ano = tt.nu_ano AND p.nu_cns::text = pp.nu_cns::text AND u.nu_cnes::text = uu.nu_cnes::text) AS domicilio_fev,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_proced_atend
             ...
             JOIN tb_dim_profissional p ON tb_fat_proced_atend.co_dim_profissional = p.co_seq_dim_profissional
             JOIN tb_dim_local_atendimento ON tb_fat_proced_atend.co_dim_local_atendimento = tb_dim_local_atendimento.co_seq_dim_local_atendimento
          WHERE t.nu_ano = tt.nu_ano AND p.nu_cns::text = pp.nu_cns::text AND u.nu_cnes::text = uu.nu_cnes::text) AS domicilio_mar,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_proced_atend
             ...
             JOIN tb_dim_profissional p ON tb_fat_proced_atend.co_dim_profissional = p.co_seq_dim_profissional
             JOIN tb_dim_local_atendimento ON tb_fat_proced_atend.co_dim_local_atendimento = tb_dim_local_atendimento.co_seq_dim_local_atendimento
          WHERE t.nu_ano = tt.nu_ano AND p.nu_cns::text = pp.nu_cns::text AND u.nu_cnes::text = uu.nu_cnes::text) AS domicilio_abr,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_proced_atend
             ...
             JOIN tb_dim_profissional p ON tb_fat_proced_atend.co_dim_profissional = p.co_seq_dim_profissional
             JOIN tb_dim_local_atendimento ON tb_fat_proced_atend.co_dim_local_atendimento = tb_dim_local_atendimento.co_seq_dim_local_atendimento
          WHERE t.nu_ano = tt.nu_ano AND p.nu_cns::text = pp.nu_cns::text AND u.nu_cnes::text = uu.nu_cnes::text) AS domicilio_mai,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_proced_atend
             ...
             JOIN tb_dim_profissional p ON tb_fat_proced_atend.co_dim_profissional = p.co_seq_dim_profissional
             JOIN tb_dim_local_atendimento ON tb_fat_proced_atend.co_dim_local_atendimento = tb_dim_local_atendimento.co_seq_dim_local_atendimento
          WHERE t.nu_ano = tt.nu_ano AND p.nu_cns::text = pp.nu_cns::text AND u.nu_cnes::text = uu.nu_cnes::text) AS domicilio_jun,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_proced_atend
             ...
             JOIN tb_dim_profissional p ON tb_fat_proced_atend.co_dim_profissional = p.co_seq_dim_profissional
             JOIN tb_dim_local_atendimento ON tb_fat_proced_atend.co_dim_local_atendimento = tb_dim_local_atendimento.co_seq_dim_local_atendimento
          WHERE t.nu_ano = tt.nu_ano AND p.nu_cns::text = pp.nu_cns::text AND u.nu_cnes::text = uu.nu_cnes::text) AS domicilio_jul,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_proced_atend
             ...
             JOIN tb_dim_profissional p ON tb_fat_proced_atend.co_dim_profissional = p.co_seq_dim_profissional
             JOIN tb_dim_local_atendimento ON tb_fat_proced_atend.co_dim_local_atendimento = tb_dim_local_atendimento.co_seq_dim_local_atendimento
          WHERE t.nu_ano = tt.nu_ano AND p.nu_cns::text = pp.nu_cns::text AND u.nu_cnes::text = uu.nu_cnes::text) AS domicilio_ago,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_proced_atend
             ...
             JOIN tb_dim_profissional p ON tb_fat_proced_atend.co_dim_profissional = p.co_seq_dim_profissional
             JOIN tb_dim_local_atendimento ON tb_fat_proced_atend.co_dim_local_atendimento = tb_dim_local_atendimento.co_seq_dim_local_atendimento
          WHERE t.nu_ano = tt.nu_ano AND p.nu_cns::text = pp.nu_cns::text AND u.nu_cnes::text = uu.nu_cnes::text) AS domicilio_set,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_proced_atend
             ...
             JOIN tb_dim_profissional p ON tb_fat_proced_atend.co_dim_profissional = p.co_seq_dim_profissional
             JOIN tb_dim_local_atendimento ON tb_fat_proced_atend.co_dim_local_atendimento = tb_dim_local_atendimento.co_seq_dim_local_atendimento
          WHERE t.nu_ano = tt.nu_ano AND p.nu_cns::text = pp.nu_cns::text AND u.nu_cnes::text = uu.nu_cnes::text) AS domicilio_out,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_proced_atend
             ...
             JOIN tb_dim_profissional p ON tb_fat_proced_atend.co_dim_profissional = p.co_seq_dim_profissional
             JOIN tb_dim_local_atendimento ON tb_fat_proced_atend.co_dim_local_atendimento = tb_dim_local_atendimento.co_seq_dim_local_atendimento
          WHERE t.nu_ano = tt.nu_ano AND p.nu_cns::text = pp.nu_cns::text AND u.nu_cnes::text = uu.nu_cnes::text) AS domicilio_nov,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_proced_atend
             ...
             JOIN tb_dim_profissional p ON tb_fat_proced_atend.co_dim_profissional = p.co_seq_dim_profissional
             JOIN tb_dim_local_atendimento ON tb_fat_proced_atend.co_dim_local_atendimento = tb_dim_local_atendimento.co_seq_dim_local_atendimento
          WHERE t.nu_ano = tt.nu_ano AND p.nu_cns::text = pp.nu_cns::text AND u.nu_cnes::text = uu.nu_cnes::text) AS domicilio_dez
   FROM tb_fat_procedimento
     JOIN tb_dim_tempo tt ON tb_fat_procedimento.co_dim_tempo = tt.co_seq_dim_tempo
     JOIN tb_dim_cbo ON tb_fat_procedimento.co_dim_cbo = tb_dim_cbo.co_seq_dim_cbo
  ...
  WHERE tb_dim_cbo.no_cbo::text = ANY (ARRAY['AUXILIAR DE ENFERMAGEM DA ESTRATÉGIA DE SAÚDE DA FAMÍLIA'::character varying::text, 'TECNICO DA ESTRATÉGIA DE SAÚDE DA FAMÍLIA'::character varying::text])
  GROUP BY tb_dim_municipio.no_municipio, uu.nu_cnes, uu.no_unidade_saude, pp.nu_cns, pp.no_profissional, tb_dim_cbo.no_cbo, tb_dim_cbo.nu_cbo, tt.nu_ano;

ALTER TABLE pmaq."TECNICO"
  OWNER TO postgres;
GRANT ALL ON TABLE pmaq."TECNICO" TO postgres;
GRANT ALL ON TABLE pmaq."TECNICO" TO pmaq;
