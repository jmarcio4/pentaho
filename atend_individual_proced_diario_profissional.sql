-- View: pmaq."ATEND_INDIVIDUAL_PROCED_DIARIO_PROFISSIONAL"

DROP VIEW if exists pmaq."ATEND_INDIVIDUAL_PROCED_DIARIO_PROFISSIONAL";

CREATE OR REPLACE VIEW pmaq."ATEND_INDIVIDUAL_PROCED_DIARIO_PROFISSIONAL" AS 
 SELECT tb_dim_municipio.no_municipio,
   ...
   FROM tb_fat_proced_atend_proced
     JOIN tb_dim_profissional pp ON tb_fat_proced_atend_proced.co_dim_profissional = pp.co_seq_dim_profissional
  ...
  GROUP BY tb_dim_procedimento.ds_proced, tb_dim_municipio.no_municipio, cc.nu_cbo, cc.no_cbo, tt.nu_ano, tt.nu_mes, uu.nu_cnes, uu.no_unidade_saude, pp.nu_cns, pp.no_profissional;

ALTER TABLE pmaq."ATEND_INDIVIDUAL_PROCED_DIARIO_PROFISSIONAL"
  OWNER TO postgres;
GRANT ALL ON TABLE pmaq."ATEND_INDIVIDUAL_PROCED_DIARIO_PROFISSIONAL" TO postgres;
GRANT ALL ON TABLE pmaq."ATEND_INDIVIDUAL_PROCED_DIARIO_PROFISSIONAL" TO pmaq;
