-- View: pmaq."ESTATISTICA_ENFERMEIRO"

DROP VIEW if exists pmaq."ESTATISTICA_ENFERMEIRO";

CREATE OR REPLACE VIEW pmaq."ESTATISTICA_ENFERMEIRO" AS 
 SELECT tb_dim_municipio.no_municipio,
  ...
  WHERE cc.no_cbo::text = 'ENFERMEIRO DA ESTRATÉGIA DE SAÚDE DA FAMÍLIA'::text
  GROUP BY tb_dim_municipio.no_municipio, uu.no_unidade_saude, uu.nu_cnes, cc.no_cbo, tt.nu_ano, cc.nu_cbo;

ALTER TABLE pmaq."ESTATISTICA_ENFERMEIRO"
  OWNER TO postgres;
GRANT ALL ON TABLE pmaq."ESTATISTICA_ENFERMEIRO" TO postgres;
GRANT ALL ON TABLE pmaq."ESTATISTICA_ENFERMEIRO" TO pmaq;
