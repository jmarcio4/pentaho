-- View: pmaq."ATEND_INDIVIDUAL_PROCED_MES_PROFISSIONAL"

DROP VIEW if exists pmaq."ATEND_INDIVIDUAL_PROCED_MES_PROFISSIONAL";

CREATE OR REPLACE VIEW pmaq."ATEND_INDIVIDUAL_PROCED_MES_PROFISSIONAL" AS 
 SELECT tb_dim_municipio.no_municipio,
  ...
  GROUP BY tb_dim_procedimento.ds_proced, cc.nu_cbo, cc.no_cbo, tb_dim_municipio.no_municipio, tt.nu_ano, uu.nu_cnes, uu.no_unidade_saude, pp.nu_cns, pp.no_profissional;

ALTER TABLE pmaq."ATEND_INDIVIDUAL_PROCED_MES_PROFISSIONAL"
  OWNER TO postgres;
GRANT ALL ON TABLE pmaq."ATEND_INDIVIDUAL_PROCED_MES_PROFISSIONAL" TO postgres;
GRANT ALL ON TABLE pmaq."ATEND_INDIVIDUAL_PROCED_MES_PROFISSIONAL" TO pmaq;
