-- View: pmaq."PROCED_ODONTO_DIARIO_MUNICIPAL"

DROP VIEW if exists pmaq."PROCED_ODONTO_DIARIO_MUNICIPAL";

CREATE OR REPLACE VIEW pmaq."PROCED_ODONTO_DIARIO_MUNICIPAL" AS 
 SELECT tb_dim_municipio.no_municipio,
  ...
  GROUP BY tb_dim_municipio.no_municipio, tt.nu_mes, tb_dim_procedimento.ds_proced, tt.nu_ano;

ALTER TABLE pmaq."PROCED_ODONTO_DIARIO_MUNICIPAL"
  OWNER TO postgres;
GRANT ALL ON TABLE pmaq."PROCED_ODONTO_DIARIO_MUNICIPAL" TO postgres;
GRANT ALL ON TABLE pmaq."PROCED_ODONTO_DIARIO_MUNICIPAL" TO pmaq;
