-- View: pmaq."PROCED_ODONTO_DIARIO_PROFISSIONAL"

DROP VIEW if exists pmaq."PROCED_ODONTO_DIARIO_PROFISSIONAL";

CREATE OR REPLACE VIEW pmaq."PROCED_ODONTO_DIARIO_PROFISSIONAL" AS 
 SELECT tb_dim_municipio.no_municipio,
    ...
    sum(
        CASE
            ...
            ELSE 0
        END) AS dia_31,
    sum(tb_fat_atend_odonto_proced.qt_procedimentos) AS sum
  ...
  GROUP BY tb_dim_municipio.no_municipio, tt.nu_mes, tb_dim_procedimento.ds_proced, uu.no_unidade_saude, pp.nu_cns, pp.no_profissional, cc.nu_cbo, cc.no_cbo, tt.nu_ano, uu.nu_cnes;

ALTER TABLE pmaq."PROCED_ODONTO_DIARIO_PROFISSIONAL"
  OWNER TO postgres;
GRANT ALL ON TABLE pmaq."PROCED_ODONTO_DIARIO_PROFISSIONAL" TO postgres;
GRANT ALL ON TABLE pmaq."PROCED_ODONTO_DIARIO_PROFISSIONAL" TO pmaq;
