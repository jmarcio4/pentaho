-- View: pmaq."PROCEDIMMENTOS_CONSOLIDADOS_MENSAL_PROFISSIONAL"

DROP VIEW if exists pmaq."PROCEDIMMENTOS_CONSOLIDADOS_MENSAL_PROFISSIONAL";

CREATE OR REPLACE VIEW pmaq."PROCEDIMMENTOS_CONSOLIDADOS_MENSAL_PROFISSIONAL" AS 
 SELECT tb_dim_municipio.no_municipio,
  ...
  GROUP BY cc.nu_cbo, cc.no_cbo, tb_dim_municipio.no_municipio, tt.nu_ano, uu.nu_cnes, uu.no_unidade_saude, pp.nu_cns, pp.no_profissional;

ALTER TABLE pmaq."PROCEDIMMENTOS_CONSOLIDADOS_MENSAL_PROFISSIONAL"
  OWNER TO postgres;
GRANT ALL ON TABLE pmaq."PROCEDIMMENTOS_CONSOLIDADOS_MENSAL_PROFISSIONAL" TO postgres;
GRANT ALL ON TABLE pmaq."PROCEDIMMENTOS_CONSOLIDADOS_MENSAL_PROFISSIONAL" TO pmaq;
