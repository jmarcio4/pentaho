-- View: pmaq."ATENDIMENTOS_MUNICIPAL"

DROP VIEW IF EXISTS pmaq."ATENDIMENTOS_MUNICIPAL";

CREATE OR REPLACE VIEW pmaq."ATENDIMENTOS_MUNICIPAL" AS 
...
ALTER TABLE pmaq."ATENDIMENTOS_MUNICIPAL"
  OWNER TO postgres;
GRANT ALL ON TABLE pmaq."ATENDIMENTOS_MUNICIPAL" TO postgres;
GRANT ALL ON TABLE pmaq."ATENDIMENTOS_MUNICIPAL" TO pmaq;
