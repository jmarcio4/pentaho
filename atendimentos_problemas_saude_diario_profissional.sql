-- View: pmaq."ATENDIMENTO_PROBLEMAS_SAUDE_DIARIO_PROFISSIONAL"

DROP VIEW IF EXISTS pmaq."ATENDIMENTO_PROBLEMAS_SAUDE_DIARIO_PROFISSIONAL";

CREATE OR REPLACE VIEW pmaq."ATENDIMENTO_PROBLEMAS_SAUDE_DIARIO_PROFISSIONAL" AS 
 SELECT tb_dim_municipio.no_municipio,
  ...
  GROUP BY tb_dim_ciap.no_ciap, tb_dim_municipio.no_municipio, tb_dim_unidade_saude.no_unidade_saude, tt.nu_mes, tb_dim_unidade_saude.nu_cnes, tb_dim_profissional.nu_cns, tb_dim_profissional.no_profissional, tb_dim_cbo.no_cbo, tt.nu_ano, tb_dim_cbo.nu_cbo;

ALTER TABLE pmaq."ATENDIMENTO_PROBLEMAS_SAUDE_DIARIO_PROFISSIONAL"
  OWNER TO postgres;
GRANT ALL ON TABLE pmaq."ATENDIMENTO_PROBLEMAS_SAUDE_DIARIO_PROFISSIONAL" TO postgres;
GRANT ALL ON TABLE pmaq."ATENDIMENTO_PROBLEMAS_SAUDE_DIARIO_PROFISSIONAL" TO pmaq;
