-- View: pmaq."TIPO_ATENDIMENTO_ODONTOLOGICO_MES"

DROP VIEW if exists pmaq."TIPO_ATENDIMENTO_ODONTOLOGICO_MES";

CREATE OR REPLACE VIEW pmaq."TIPO_ATENDIMENTO_ODONTOLOGICO_MES" AS 
...
ALTER TABLE pmaq."TIPO_ATENDIMENTO_ODONTOLOGICO_MES"
  OWNER TO postgres;
GRANT ALL ON TABLE pmaq."TIPO_ATENDIMENTO_ODONTOLOGICO_MES" TO postgres;
GRANT ALL ON TABLE pmaq."TIPO_ATENDIMENTO_ODONTOLOGICO_MES" TO pmaq;
