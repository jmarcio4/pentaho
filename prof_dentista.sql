-- View: pmaq."PROF_DENTISTA"

DROP VIEW if exists pmaq."PROF_DENTISTA";

CREATE OR REPLACE VIEW pmaq."PROF_DENTISTA" AS 
 SELECT tb_unidade_saude.nu_cnes,
  ...
  WHERE tb_lotacao.st_ativo = 1 AND tb_lotacao.st_importada = 1 AND tb_cbo.co_cbo_2002::text = '223293'::text
...
ALTER TABLE pmaq."PROF_DENTISTA"
  OWNER TO postgres;
GRANT ALL ON TABLE pmaq."PROF_DENTISTA" TO postgres;
GRANT ALL ON TABLE pmaq."PROF_DENTISTA" TO pmaq;
