-- View: pmaq."ENFERMEIRO"

DROP VIEW if exists pmaq."ENFERMEIRO";

CREATE OR REPLACE VIEW pmaq."ENFERMEIRO" AS 
 SELECT tb_dim_municipio.no_municipio,
    ...
    ( SELECT count(
          ...
          WHERE to_char(tb_cds_ficha_ativ_col.dt_ativ_col, 'YYYY'::text)::integer = tt.nu_ano AND p.nu_cns::text = pp.nu_cns::text AND u.nu_cnes::text = uu.nu_cnes::text) AS reuni_jan,
    ( SELECT count(
                CASE
           ...
           FROM tb_cds_tipo_ativ_col
             ...
             JOIN tb_dim_unidade_saude u ON p.nu_cnes::text = u.nu_cnes::text
             JOIN tb_dim_cbo c ON p.nu_cbo_2002::text = c.nu_cbo::text
          WHERE to_char(tb_cds_ficha_ativ_col.dt_ativ_col, 'YYYY'::text)::integer = tt.nu_ano AND p.nu_cns::text = pp.nu_cns::text AND u.nu_cnes::text = uu.nu_cnes::text) AS reuni_fev,
    ( SELECT count(
                CASE
           ...
           FROM tb_cds_tipo_ativ_col
             ...
             JOIN tb_dim_unidade_saude u ON p.nu_cnes::text = u.nu_cnes::text
             JOIN tb_dim_cbo c ON p.nu_cbo_2002::text = c.nu_cbo::text
          WHERE to_char(tb_cds_ficha_ativ_col.dt_ativ_col, 'YYYY'::text)::integer = tt.nu_ano AND p.nu_cns::text = pp.nu_cns::text AND u.nu_cnes::text = uu.nu_cnes::text) AS reuni_marc,
    ( SELECT count(
                CASE
           ...
           FROM tb_cds_tipo_ativ_col
             ...
             JOIN tb_dim_unidade_saude u ON p.nu_cnes::text = u.nu_cnes::text
             JOIN tb_dim_cbo c ON p.nu_cbo_2002::text = c.nu_cbo::text
          WHERE to_char(tb_cds_ficha_ativ_col.dt_ativ_col, 'YYYY'::text)::integer = tt.nu_ano AND p.nu_cns::text = pp.nu_cns::text AND u.nu_cnes::text = uu.nu_cnes::text) AS reuni_abril,
    ( SELECT count(
                CASE
           ...
           FROM tb_cds_tipo_ativ_col
             ...
             JOIN tb_dim_unidade_saude u ON p.nu_cnes::text = u.nu_cnes::text
             JOIN tb_dim_cbo c ON p.nu_cbo_2002::text = c.nu_cbo::text
          WHERE to_char(tb_cds_ficha_ativ_col.dt_ativ_col, 'YYYY'::text)::integer = tt.nu_ano AND p.nu_cns::text = pp.nu_cns::text AND u.nu_cnes::text = uu.nu_cnes::text) AS reuni_maio,
    ( SELECT count(
                CASE
           ...
           FROM tb_cds_tipo_ativ_col
             ...
             JOIN tb_dim_unidade_saude u ON p.nu_cnes::text = u.nu_cnes::text
             JOIN tb_dim_cbo c ON p.nu_cbo_2002::text = c.nu_cbo::text
          WHERE to_char(tb_cds_ficha_ativ_col.dt_ativ_col, 'YYYY'::text)::integer = tt.nu_ano AND p.nu_cns::text = pp.nu_cns::text AND u.nu_cnes::text = uu.nu_cnes::text) AS reuni_jun,
    ( SELECT count(
                CASE
           ...
           FROM tb_cds_tipo_ativ_col
             ...
             JOIN tb_dim_unidade_saude u ON p.nu_cnes::text = u.nu_cnes::text
             JOIN tb_dim_cbo c ON p.nu_cbo_2002::text = c.nu_cbo::text
          WHERE to_char(tb_cds_ficha_ativ_col.dt_ativ_col, 'YYYY'::text)::integer = tt.nu_ano AND p.nu_cns::text = pp.nu_cns::text AND u.nu_cnes::text = uu.nu_cnes::text) AS reuni_julho,
    ( SELECT count(
                CASE
           ...
           FROM tb_cds_tipo_ativ_col
             ...
             JOIN tb_dim_unidade_saude u ON p.nu_cnes::text = u.nu_cnes::text
             JOIN tb_dim_cbo c ON p.nu_cbo_2002::text = c.nu_cbo::text
          WHERE to_char(tb_cds_ficha_ativ_col.dt_ativ_col, 'YYYY'::text)::integer = tt.nu_ano AND p.nu_cns::text = pp.nu_cns::text AND u.nu_cnes::text = uu.nu_cnes::text) AS reuni_agosto,
    ( SELECT count(
                CASE
           ...
           FROM tb_cds_tipo_ativ_col
             ...
             JOIN tb_dim_unidade_saude u ON p.nu_cnes::text = u.nu_cnes::text
             JOIN tb_dim_cbo c ON p.nu_cbo_2002::text = c.nu_cbo::text
          WHERE to_char(tb_cds_ficha_ativ_col.dt_ativ_col, 'YYYY'::text)::integer = tt.nu_ano AND p.nu_cns::text = pp.nu_cns::text AND u.nu_cnes::text = uu.nu_cnes::text) AS reuni_setemb,
    ( SELECT count(
                CASE
           ...
           FROM tb_cds_tipo_ativ_col
             ...
             JOIN tb_dim_unidade_saude u ON p.nu_cnes::text = u.nu_cnes::text
             JOIN tb_dim_cbo c ON p.nu_cbo_2002::text = c.nu_cbo::text
          WHERE to_char(tb_cds_ficha_ativ_col.dt_ativ_col, 'YYYY'::text)::integer = tt.nu_ano AND p.nu_cns::text = pp.nu_cns::text AND u.nu_cnes::text = uu.nu_cnes::text) AS reuni_outu,
    ( SELECT count(
                CASE
           ...
           FROM tb_cds_tipo_ativ_col
             ...
             JOIN tb_dim_unidade_saude u ON p.nu_cnes::text = u.nu_cnes::text
             JOIN tb_dim_cbo c ON p.nu_cbo_2002::text = c.nu_cbo::text
          WHERE to_char(tb_cds_ficha_ativ_col.dt_ativ_col, 'YYYY'::text)::integer = tt.nu_ano AND p.nu_cns::text = pp.nu_cns::text AND u.nu_cnes::text = uu.nu_cnes::text) AS reuni_nov,
    ( SELECT count(
                CASE
           ...
           FROM tb_cds_tipo_ativ_col
             ...
             JOIN tb_dim_unidade_saude u ON p.nu_cnes::text = u.nu_cnes::text
             JOIN tb_dim_cbo c ON p.nu_cbo_2002::text = c.nu_cbo::text
          WHERE to_char(tb_cds_ficha_ativ_col.dt_ativ_col, 'YYYY'::text)::integer = tt.nu_ano AND p.nu_cns::text = pp.nu_cns::text AND u.nu_cnes::text = uu.nu_cnes::text) AS reuni_dez,
    ( SELECT count(
                CASE
                    WHEN tb_dim_procedimento.ds_proced::text ~~ 'COLETA DE CITOPATOLÓGICO DE COLO UTERINO%'::text AND t.nu_mes = 1 THEN 1
                    ELSE NULL::integer
                END) AS count
          ...
          WHERE p.nu_cns::text = pp.nu_cns::text AND t.nu_ano = tt.nu_ano AND u.nu_cnes::text = uu.nu_cnes::text) AS cit_janeiro,
    ( SELECT count(
                CASE
                    WHEN tb_dim_procedimento.ds_proced::text ~~ 'COLETA DE CITOPATOLÓGICO DE COLO UTERINO%'::text AND t.nu_mes = 2 THEN 1
                    ELSE NULL::integer
                END) AS count
           FROM tb_fat_proced_atend_proced
             JOIN tb_dim_procedimento ON tb_fat_proced_atend_proced.co_dim_procedimento = tb_dim_procedimento.co_seq_dim_procedimento
             ...
             JOIN tb_dim_unidade_saude u ON tb_fat_proced_atend_proced.co_dim_unidade_saude = u.co_seq_dim_unidade_saude
             JOIN tb_dim_cbo c ON tb_fat_proced_atend_proced.co_dim_cbo = c.co_seq_dim_cbo
          WHERE p.nu_cns::text = pp.nu_cns::text AND t.nu_ano = tt.nu_ano AND u.nu_cnes::text = uu.nu_cnes::text) AS cit_fev,
    ( SELECT count(
                CASE
                    WHEN tb_dim_procedimento.ds_proced::text ~~ 'COLETA DE CITOPATOLÓGICO DE COLO UTERINO%'::text AND t.nu_mes = 3 THEN 1
                    ELSE NULL::integer
                END) AS count
           FROM tb_fat_proced_atend_proced
             JOIN tb_dim_procedimento ON tb_fat_proced_atend_proced.co_dim_procedimento = tb_dim_procedimento.co_seq_dim_procedimento
             ...
             JOIN tb_dim_unidade_saude u ON tb_fat_proced_atend_proced.co_dim_unidade_saude = u.co_seq_dim_unidade_saude
             JOIN tb_dim_cbo c ON tb_fat_proced_atend_proced.co_dim_cbo = c.co_seq_dim_cbo
          WHERE p.nu_cns::text = pp.nu_cns::text AND t.nu_ano = tt.nu_ano AND u.nu_cnes::text = uu.nu_cnes::text) AS cit_marc,
    ( SELECT count(
                CASE
                    WHEN tb_dim_procedimento.ds_proced::text ~~ 'COLETA DE CITOPATOLÓGICO DE COLO UTERINO%'::text AND t.nu_mes = 4 THEN 1
                    ELSE NULL::integer
                END) AS count
           FROM tb_fat_proced_atend_proced
             JOIN tb_dim_procedimento ON tb_fat_proced_atend_proced.co_dim_procedimento = tb_dim_procedimento.co_seq_dim_procedimento
             ...
             JOIN tb_dim_unidade_saude u ON tb_fat_proced_atend_proced.co_dim_unidade_saude = u.co_seq_dim_unidade_saude
             JOIN tb_dim_cbo c ON tb_fat_proced_atend_proced.co_dim_cbo = c.co_seq_dim_cbo
          WHERE p.nu_cns::text = pp.nu_cns::text AND t.nu_ano = tt.nu_ano AND u.nu_cnes::text = uu.nu_cnes::text) AS cit_abril,
    ( SELECT count(
                CASE
                    WHEN tb_dim_procedimento.ds_proced::text ~~ 'COLETA DE CITOPATOLÓGICO DE COLO UTERINO%'::text AND t.nu_mes = 5 THEN 1
                    ELSE NULL::integer
                END) AS count
           FROM tb_fat_proced_atend_proced
             JOIN tb_dim_procedimento ON tb_fat_proced_atend_proced.co_dim_procedimento = tb_dim_procedimento.co_seq_dim_procedimento
             ...
             JOIN tb_dim_unidade_saude u ON tb_fat_proced_atend_proced.co_dim_unidade_saude = u.co_seq_dim_unidade_saude
             JOIN tb_dim_cbo c ON tb_fat_proced_atend_proced.co_dim_cbo = c.co_seq_dim_cbo
          WHERE p.nu_cns::text = pp.nu_cns::text AND t.nu_ano = tt.nu_ano AND u.nu_cnes::text = uu.nu_cnes::text) AS cit_maio,
    ( SELECT count(
                CASE
                    WHEN tb_dim_procedimento.ds_proced::text ~~ 'COLETA DE CITOPATOLÓGICO DE COLO UTERINO%'::text AND t.nu_mes = 6 THEN 1
                    ELSE NULL::integer
                END) AS count
           FROM tb_fat_proced_atend_proced
             JOIN tb_dim_procedimento ON tb_fat_proced_atend_proced.co_dim_procedimento = tb_dim_procedimento.co_seq_dim_procedimento
             ...
             JOIN tb_dim_unidade_saude u ON tb_fat_proced_atend_proced.co_dim_unidade_saude = u.co_seq_dim_unidade_saude
             JOIN tb_dim_cbo c ON tb_fat_proced_atend_proced.co_dim_cbo = c.co_seq_dim_cbo
          WHERE p.nu_cns::text = pp.nu_cns::text AND t.nu_ano = tt.nu_ano AND u.nu_cnes::text = uu.nu_cnes::text) AS cit_junho,
    ( SELECT count(
                CASE
                    WHEN tb_dim_procedimento.ds_proced::text ~~ 'COLETA DE CITOPATOLÓGICO DE COLO UTERINO%'::text AND t.nu_mes = 7 THEN 1
                    ELSE NULL::integer
                END) AS count
           FROM tb_fat_proced_atend_proced
             JOIN tb_dim_procedimento ON tb_fat_proced_atend_proced.co_dim_procedimento = tb_dim_procedimento.co_seq_dim_procedimento
             ...
             JOIN tb_dim_unidade_saude u ON tb_fat_proced_atend_proced.co_dim_unidade_saude = u.co_seq_dim_unidade_saude
             JOIN tb_dim_cbo c ON tb_fat_proced_atend_proced.co_dim_cbo = c.co_seq_dim_cbo
          WHERE p.nu_cns::text = pp.nu_cns::text AND t.nu_ano = tt.nu_ano AND u.nu_cnes::text = uu.nu_cnes::text) AS cit_julho,
    ( SELECT count(
                CASE
                    WHEN tb_dim_procedimento.ds_proced::text ~~ 'COLETA DE CITOPATOLÓGICO DE COLO UTERINO%'::text AND t.nu_mes = 8 THEN 1
                    ELSE NULL::integer
                END) AS count
           FROM tb_fat_proced_atend_proced
             JOIN tb_dim_procedimento ON tb_fat_proced_atend_proced.co_dim_procedimento = tb_dim_procedimento.co_seq_dim_procedimento
             ...
             JOIN tb_dim_unidade_saude u ON tb_fat_proced_atend_proced.co_dim_unidade_saude = u.co_seq_dim_unidade_saude
             JOIN tb_dim_cbo c ON tb_fat_proced_atend_proced.co_dim_cbo = c.co_seq_dim_cbo
          WHERE p.nu_cns::text = pp.nu_cns::text AND t.nu_ano = tt.nu_ano AND u.nu_cnes::text = uu.nu_cnes::text) AS cit_agosto,
    ( SELECT count(
                CASE
                    WHEN tb_dim_procedimento.ds_proced::text ~~ 'COLETA DE CITOPATOLÓGICO DE COLO UTERINO%'::text AND t.nu_mes = 9 THEN 1
                    ELSE NULL::integer
                END) AS count
           FROM tb_fat_proced_atend_proced
             JOIN tb_dim_procedimento ON tb_fat_proced_atend_proced.co_dim_procedimento = tb_dim_procedimento.co_seq_dim_procedimento
             ...
             JOIN tb_dim_unidade_saude u ON tb_fat_proced_atend_proced.co_dim_unidade_saude = u.co_seq_dim_unidade_saude
             JOIN tb_dim_cbo c ON tb_fat_proced_atend_proced.co_dim_cbo = c.co_seq_dim_cbo
          WHERE p.nu_cns::text = pp.nu_cns::text AND t.nu_ano = tt.nu_ano AND u.nu_cnes::text = uu.nu_cnes::text) AS cit_setembro,
    ( SELECT count(
                CASE
                    WHEN tb_dim_procedimento.ds_proced::text ~~ 'COLETA DE CITOPATOLÓGICO DE COLO UTERINO%'::text AND t.nu_mes = 10 THEN 1
                    ELSE NULL::integer
                END) AS count
           FROM tb_fat_proced_atend_proced
             JOIN tb_dim_procedimento ON tb_fat_proced_atend_proced.co_dim_procedimento = tb_dim_procedimento.co_seq_dim_procedimento
             ...
             JOIN tb_dim_unidade_saude u ON tb_fat_proced_atend_proced.co_dim_unidade_saude = u.co_seq_dim_unidade_saude
             JOIN tb_dim_cbo c ON tb_fat_proced_atend_proced.co_dim_cbo = c.co_seq_dim_cbo
          WHERE p.nu_cns::text = pp.nu_cns::text AND t.nu_ano = tt.nu_ano AND u.nu_cnes::text = uu.nu_cnes::text) AS cit_outubro,
    ( SELECT count(
                CASE
                    WHEN tb_dim_procedimento.ds_proced::text ~~ 'COLETA DE CITOPATOLÓGICO DE COLO UTERINO%'::text AND t.nu_mes = 11 THEN 1
                    ELSE NULL::integer
                END) AS count
           FROM tb_fat_proced_atend_proced
             JOIN tb_dim_procedimento ON tb_fat_proced_atend_proced.co_dim_procedimento = tb_dim_procedimento.co_seq_dim_procedimento
             ...
             JOIN tb_dim_unidade_saude u ON tb_fat_proced_atend_proced.co_dim_unidade_saude = u.co_seq_dim_unidade_saude
             JOIN tb_dim_cbo c ON tb_fat_proced_atend_proced.co_dim_cbo = c.co_seq_dim_cbo
          WHERE p.nu_cns::text = pp.nu_cns::text AND t.nu_ano = tt.nu_ano AND u.nu_cnes::text = uu.nu_cnes::text) AS cit_novembro,
    ( SELECT count(
                CASE
                    WHEN tb_dim_procedimento.ds_proced::text ~~ 'COLETA DE CITOPATOLÓGICO DE COLO UTERINO%'::text AND t.nu_mes = 12 THEN 1
                    ELSE NULL::integer
                END) AS count
           FROM tb_fat_proced_atend_proced
             JOIN tb_dim_procedimento ON tb_fat_proced_atend_proced.co_dim_procedimento = tb_dim_procedimento.co_seq_dim_procedimento
             ...
             JOIN tb_dim_unidade_saude u ON tb_fat_proced_atend_proced.co_dim_unidade_saude = u.co_seq_dim_unidade_saude
             JOIN tb_dim_cbo c ON tb_fat_proced_atend_proced.co_dim_cbo = c.co_seq_dim_cbo
          WHERE p.nu_cns::text = pp.nu_cns::text AND t.nu_ano = tt.nu_ano AND u.nu_cnes::text = uu.nu_cnes::text) AS cit_dezembro,
    count(
        CASE
    ...
    ( SELECT count(
          ...
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS domi_jan,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_tempo t ON tb_fat_atendimento_individual.co_dim_tempo = t.co_seq_dim_tempo
             JOIN tb_dim_local_atendimento ON tb_fat_atendimento_individual.co_dim_local_atendimento = tb_dim_local_atendimento.co_seq_dim_local_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS domi_fev,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_tempo t ON tb_fat_atendimento_individual.co_dim_tempo = t.co_seq_dim_tempo
             JOIN tb_dim_local_atendimento ON tb_fat_atendimento_individual.co_dim_local_atendimento = tb_dim_local_atendimento.co_seq_dim_local_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS domi_marc,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_tempo t ON tb_fat_atendimento_individual.co_dim_tempo = t.co_seq_dim_tempo
             JOIN tb_dim_local_atendimento ON tb_fat_atendimento_individual.co_dim_local_atendimento = tb_dim_local_atendimento.co_seq_dim_local_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS domi_abril,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_tempo t ON tb_fat_atendimento_individual.co_dim_tempo = t.co_seq_dim_tempo
             JOIN tb_dim_local_atendimento ON tb_fat_atendimento_individual.co_dim_local_atendimento = tb_dim_local_atendimento.co_seq_dim_local_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS domi_maio,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_tempo t ON tb_fat_atendimento_individual.co_dim_tempo = t.co_seq_dim_tempo
             JOIN tb_dim_local_atendimento ON tb_fat_atendimento_individual.co_dim_local_atendimento = tb_dim_local_atendimento.co_seq_dim_local_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS domi_junho,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_tempo t ON tb_fat_atendimento_individual.co_dim_tempo = t.co_seq_dim_tempo
             JOIN tb_dim_local_atendimento ON tb_fat_atendimento_individual.co_dim_local_atendimento = tb_dim_local_atendimento.co_seq_dim_local_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS domi_jul,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_tempo t ON tb_fat_atendimento_individual.co_dim_tempo = t.co_seq_dim_tempo
             JOIN tb_dim_local_atendimento ON tb_fat_atendimento_individual.co_dim_local_atendimento = tb_dim_local_atendimento.co_seq_dim_local_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS domi_agosto,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_tempo t ON tb_fat_atendimento_individual.co_dim_tempo = t.co_seq_dim_tempo
             JOIN tb_dim_local_atendimento ON tb_fat_atendimento_individual.co_dim_local_atendimento = tb_dim_local_atendimento.co_seq_dim_local_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS domi_set,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_tempo t ON tb_fat_atendimento_individual.co_dim_tempo = t.co_seq_dim_tempo
             JOIN tb_dim_local_atendimento ON tb_fat_atendimento_individual.co_dim_local_atendimento = tb_dim_local_atendimento.co_seq_dim_local_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS domi_out,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_tempo t ON tb_fat_atendimento_individual.co_dim_tempo = t.co_seq_dim_tempo
             JOIN tb_dim_local_atendimento ON tb_fat_atendimento_individual.co_dim_local_atendimento = tb_dim_local_atendimento.co_seq_dim_local_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS domi_nov,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_tempo t ON tb_fat_atendimento_individual.co_dim_tempo = t.co_seq_dim_tempo
             JOIN tb_dim_local_atendimento ON tb_fat_atendimento_individual.co_dim_local_atendimento = tb_dim_local_atendimento.co_seq_dim_local_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS domi_dez,
    ( SELECT count(
                CASE
          ...
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS programada_jan,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS programada_fev,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS programada_marc,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS programada_abril,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS programada_maio,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS programada_junho,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS programada_julho,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS programada_agosto,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS programada_setem,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS programada_outubro,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS programada_novembro,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS programada_dez,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND t.nu_ano = tt.nu_ano) AS atendimento_jan,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND t.nu_ano = tt.nu_ano) AS atendimento_fev,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND t.nu_ano = tt.nu_ano) AS atendimento_marc,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND t.nu_ano = tt.nu_ano) AS atendimento_abril,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND t.nu_ano = tt.nu_ano) AS atendimento_maio,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND t.nu_ano = tt.nu_ano) AS atendimento_junho,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND t.nu_ano = tt.nu_ano) AS atendimento_julho,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND t.nu_ano = tt.nu_ano) AS atendimento_agosto,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND t.nu_ano = tt.nu_ano) AS atendimento_setemb,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND t.nu_ano = tt.nu_ano) AS atendimento_outubro,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND t.nu_ano = tt.nu_ano) AS atendimento_novembro,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND t.nu_ano = tt.nu_ano) AS atendimento_dezembro,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS demanda_jan,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS demanda_fev,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS demanda_marc,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS demanda_abril,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS demanda_maio,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS demanda_junho,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS demanda_julho,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS demanda_agosto,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS demanda_setem,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS demanda_outubro,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS demanda_novembro,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS demanda_dez,
    ( SELECT count(
                CASE
                    WHEN (tb_dim_tipo_atendimento.ds_tipo_atendimento::text = ANY (ARRAY['Consulta agendada'::character varying::text, 'Consulta agendada programada / Cuidado continuado'::character varying::text])) AND t.nu_mes = 1 THEN 1
                    ELSE NULL::integer
                END) AS count
           FROM tb_fat_atendimento_individual
             JOIN tb_dim_profissional p ON tb_fat_atendimento_individual.co_dim_profissional_1 = p.co_seq_dim_profissional
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS agendada_jan,
    ( SELECT count(
                CASE
                    WHEN (tb_dim_tipo_atendimento.ds_tipo_atendimento::text = ANY (ARRAY['Consulta agendada'::character varying::text, 'Consulta agendada programada / Cuidado continuado'::character varying::text])) AND t.nu_mes = 2 THEN 1
                    ELSE NULL::integer
                END) AS count
           FROM tb_fat_atendimento_individual
             JOIN tb_dim_profissional p ON tb_fat_atendimento_individual.co_dim_profissional_1 = p.co_seq_dim_profissional
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS agendada_fev,
    ( SELECT count(
                CASE
                    WHEN (tb_dim_tipo_atendimento.ds_tipo_atendimento::text = ANY (ARRAY['Consulta agendada'::character varying::text, 'Consulta agendada programada / Cuidado continuado'::character varying::text])) AND t.nu_mes = 3 THEN 1
                    ELSE NULL::integer
                END) AS count
           FROM tb_fat_atendimento_individual
             JOIN tb_dim_profissional p ON tb_fat_atendimento_individual.co_dim_profissional_1 = p.co_seq_dim_profissional
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS agendada_marc,
    ( SELECT count(
                CASE
                    WHEN (tb_dim_tipo_atendimento.ds_tipo_atendimento::text = ANY (ARRAY['Consulta agendada'::character varying::text, 'Consulta agendada programada / Cuidado continuado'::character varying::text])) AND t.nu_mes = 4 THEN 1
                    ELSE NULL::integer
                END) AS count
           FROM tb_fat_atendimento_individual
             JOIN tb_dim_profissional p ON tb_fat_atendimento_individual.co_dim_profissional_1 = p.co_seq_dim_profissional
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS agendada_abr,
    ( SELECT count(
                CASE
                    WHEN (tb_dim_tipo_atendimento.ds_tipo_atendimento::text = ANY (ARRAY['Consulta agendada'::character varying::text, 'Consulta agendada programada / Cuidado continuado'::character varying::text])) AND t.nu_mes = 5 THEN 1
                    ELSE NULL::integer
                END) AS count
           FROM tb_fat_atendimento_individual
             JOIN tb_dim_profissional p ON tb_fat_atendimento_individual.co_dim_profissional_1 = p.co_seq_dim_profissional
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS agendada_mai,
    ( SELECT count(
                CASE
                    WHEN (tb_dim_tipo_atendimento.ds_tipo_atendimento::text = ANY (ARRAY['Consulta agendada'::character varying::text, 'Consulta agendada programada / Cuidado continuado'::character varying::text])) AND t.nu_mes = 6 THEN 1
                    ELSE NULL::integer
                END) AS count
           FROM tb_fat_atendimento_individual
             JOIN tb_dim_profissional p ON tb_fat_atendimento_individual.co_dim_profissional_1 = p.co_seq_dim_profissional
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS agendada_jun,
    ( SELECT count(
                CASE
                    WHEN (tb_dim_tipo_atendimento.ds_tipo_atendimento::text = ANY (ARRAY['Consulta agendada'::character varying::text, 'Consulta agendada programada / Cuidado continuado'::character varying::text])) AND t.nu_mes = 7 THEN 1
                    ELSE NULL::integer
                END) AS count
           FROM tb_fat_atendimento_individual
             JOIN tb_dim_profissional p ON tb_fat_atendimento_individual.co_dim_profissional_1 = p.co_seq_dim_profissional
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS agendada_jul,
    ( SELECT count(
                CASE
                    WHEN (tb_dim_tipo_atendimento.ds_tipo_atendimento::text = ANY (ARRAY['Consulta agendada'::text, 'Consulta agendada programada / Cuidado continuado'::text])) AND t.nu_mes = 8 THEN 1
                    ELSE NULL::integer
                END) AS count
           FROM tb_fat_atendimento_individual
             JOIN tb_dim_profissional p ON tb_fat_atendimento_individual.co_dim_profissional_1 = p.co_seq_dim_profissional
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS agendada_ago,
    ( SELECT count(
                CASE
                    WHEN (tb_dim_tipo_atendimento.ds_tipo_atendimento::text = ANY (ARRAY['Consulta agendada'::character varying::text, 'Consulta agendada programada / Cuidado continuado'::character varying::text])) AND t.nu_mes = 9 THEN 1
                    ELSE NULL::integer
                END) AS count
           FROM tb_fat_atendimento_individual
             JOIN tb_dim_profissional p ON tb_fat_atendimento_individual.co_dim_profissional_1 = p.co_seq_dim_profissional
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS agendada_set,
    ( SELECT count(
                CASE
                    WHEN (tb_dim_tipo_atendimento.ds_tipo_atendimento::text = ANY (ARRAY['Consulta agendada'::character varying::text, 'Consulta agendada programada / Cuidado continuado'::character varying::text])) AND t.nu_mes = 10 THEN 1
                    ELSE NULL::integer
                END) AS count
           FROM tb_fat_atendimento_individual
             JOIN tb_dim_profissional p ON tb_fat_atendimento_individual.co_dim_profissional_1 = p.co_seq_dim_profissional
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS agendada_out,
    ( SELECT count(
                CASE
                    WHEN (tb_dim_tipo_atendimento.ds_tipo_atendimento::text = ANY (ARRAY['Consulta agendada'::text, 'Consulta agendada programada / Cuidado continuado'::text])) AND t.nu_mes = 11 THEN 1
                    ELSE NULL::integer
                END) AS count
           FROM tb_fat_atendimento_individual
             JOIN tb_dim_profissional p ON tb_fat_atendimento_individual.co_dim_profissional_1 = p.co_seq_dim_profissional
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS agendada_nov,
    ( SELECT count(
                CASE
                    WHEN (tb_dim_tipo_atendimento.ds_tipo_atendimento::text = ANY (ARRAY['Consulta agendada'::text, 'Consulta agendada programada / Cuidado continuado'::text])) AND t.nu_mes = 12 THEN 1
                    ELSE NULL::integer
                END) AS count
           FROM tb_fat_atendimento_individual
             JOIN tb_dim_profissional p ON tb_fat_atendimento_individual.co_dim_profissional_1 = p.co_seq_dim_profissional
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS agendada_dez,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS encaminha_jan,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS encaminha_fev,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS encaminha_mar,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS encaminha_abr,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS encaminha_mai,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS encaminha_jun,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS encaminha_jul,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS encaminha_ago,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS encaminha_set,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS encaminha_out,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS encaminha_nov,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = pp.nu_cns::text AND tt.nu_ano = t.nu_ano) AS encaminha_dez
   FROM tb_fat_atd_ind_problemas
     JOIN tb_dim_profissional pp ON tb_fat_atd_ind_problemas.co_dim_profissional_1 = pp.co_seq_dim_profissional
  ...
  WHERE cc.nu_cbo::text = '223565'::text
  GROUP BY tb_dim_municipio.no_municipio, uu.no_unidade_saude, uu.nu_cnes, pp.nu_cns, pp.no_profissional, cc.no_cbo, tt.nu_ano, cc.nu_cbo;

ALTER TABLE pmaq."ENFERMEIRO"
  OWNER TO postgres;
GRANT ALL ON TABLE pmaq."ENFERMEIRO" TO postgres;
GRANT ALL ON TABLE pmaq."ENFERMEIRO" TO pmaq;
