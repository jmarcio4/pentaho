-- View: pmaq."PROBLEMA_UNIDADE_CBO"

DROP VIEW if exists pmaq."PROBLEMA_UNIDADE_CBO";

CREATE OR REPLACE VIEW pmaq."PROBLEMA_UNIDADE_CBO" AS 
 SELECT tb_dim_municipio.no_municipio,
  ...
  GROUP BY tb_dim_ciap.no_ciap, tb_dim_municipio.no_municipio, tb_dim_cbo.no_cbo, tb_dim_unidade_saude.no_unidade_saude, tb_dim_unidade_saude.nu_cnes, tt.nu_ano
  ORDER BY tb_dim_unidade_saude.no_unidade_saude;

ALTER TABLE pmaq."PROBLEMA_UNIDADE_CBO"
  OWNER TO postgres;
GRANT ALL ON TABLE pmaq."PROBLEMA_UNIDADE_CBO" TO postgres;
GRANT ALL ON TABLE pmaq."PROBLEMA_UNIDADE_CBO" TO pmaq;
