-- View: pmaq."PROF_ENFERMEIRO"

DROP VIEW if exists pmaq."PROF_ENFERMEIRO";

CREATE OR REPLACE VIEW pmaq."PROF_ENFERMEIRO" AS 
 SELECT tb_unidade_saude.nu_cnes,
  ...
  WHERE tb_lotacao.st_ativo = 1 AND tb_lotacao.st_importada = 1 AND tb_cbo.co_cbo_2002::text = '223565'::text
...
ALTER TABLE pmaq."PROF_ENFERMEIRO"
  OWNER TO postgres;
GRANT ALL ON TABLE pmaq."PROF_ENFERMEIRO" TO postgres;
GRANT ALL ON TABLE pmaq."PROF_ENFERMEIRO" TO pmaq;
