-- View: pmaq."PROCED_ODONTO_MES_PROFISSIONAL"

DROP VIEW if exists pmaq."PROCED_ODONTO_MES_PROFISSIONAL";

CREATE OR REPLACE VIEW pmaq."PROCED_ODONTO_MES_PROFISSIONAL" AS 
...
ALTER TABLE pmaq."PROCED_ODONTO_MES_PROFISSIONAL"
  OWNER TO postgres;
GRANT ALL ON TABLE pmaq."PROCED_ODONTO_MES_PROFISSIONAL" TO postgres;
GRANT ALL ON TABLE pmaq."PROCED_ODONTO_MES_PROFISSIONAL" TO pmaq;
