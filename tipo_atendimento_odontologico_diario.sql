-- View: pmaq."TIPO_ATENDIMENTO_ODONTOLOGICO_DIARIO"

DROP VIEW if exists pmaq."TIPO_ATENDIMENTO_ODONTOLOGICO_DIARIO";

CREATE OR REPLACE VIEW pmaq."TIPO_ATENDIMENTO_ODONTOLOGICO_DIARIO" AS 
 SELECT tb_dim_municipio.no_municipio,
  ...
  GROUP BY tb_dim_municipio.no_municipio, t.nu_mes, uu.no_unidade_saude, pp.nu_cns, pp.no_profissional, cc.nu_cbo, cc.no_cbo, t.nu_ano, uu.nu_cnes, tb_dim_tipo_atendimento.ds_tipo_atendimento;

ALTER TABLE pmaq."TIPO_ATENDIMENTO_ODONTOLOGICO_DIARIO"
  OWNER TO postgres;
GRANT ALL ON TABLE pmaq."TIPO_ATENDIMENTO_ODONTOLOGICO_DIARIO" TO postgres;
GRANT ALL ON TABLE pmaq."TIPO_ATENDIMENTO_ODONTOLOGICO_DIARIO" TO pmaq;
