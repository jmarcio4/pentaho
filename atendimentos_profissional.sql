-- View: pmaq."ATENDIMENTOS_PROFISSIONAL"

DROP VIEW IF EXISTS pmaq."ATENDIMENTOS_PROFISSIONAL";

CREATE OR REPLACE VIEW pmaq."ATENDIMENTOS_PROFISSIONAL" AS 
 SELECT tb_dim_municipio.no_municipio,
    ...
    ( SELECT count(
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_tempo t ON tb_fat_atendimento_individual.co_dim_tempo = t.co_seq_dim_tempo
             JOIN tb_dim_local_atendimento ON tb_fat_atendimento_individual.co_dim_local_atendimento = tb_dim_local_atendimento.co_seq_dim_local_atendimento
          WHERE p.nu_cns::text = tb_dim_profissional.nu_cns::text AND tb_dim_tempo.nu_ano = t.nu_ano) AS domi_mar,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_tempo t ON tb_fat_atendimento_individual.co_dim_tempo = t.co_seq_dim_tempo
             JOIN tb_dim_local_atendimento ON tb_fat_atendimento_individual.co_dim_local_atendimento = tb_dim_local_atendimento.co_seq_dim_local_atendimento
          WHERE p.nu_cns::text = tb_dim_profissional.nu_cns::text AND tb_dim_tempo.nu_ano = t.nu_ano) AS domi_abr,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_tempo t ON tb_fat_atendimento_individual.co_dim_tempo = t.co_seq_dim_tempo
             JOIN tb_dim_local_atendimento ON tb_fat_atendimento_individual.co_dim_local_atendimento = tb_dim_local_atendimento.co_seq_dim_local_atendimento
          WHERE p.nu_cns::text = tb_dim_profissional.nu_cns::text AND tb_dim_tempo.nu_ano = t.nu_ano) AS domi_mai,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_tempo t ON tb_fat_atendimento_individual.co_dim_tempo = t.co_seq_dim_tempo
             JOIN tb_dim_local_atendimento ON tb_fat_atendimento_individual.co_dim_local_atendimento = tb_dim_local_atendimento.co_seq_dim_local_atendimento
          WHERE p.nu_cns::text = tb_dim_profissional.nu_cns::text AND tb_dim_tempo.nu_ano = t.nu_ano) AS domi_jun,
    ( SELECT count(
                CASE
    ...
    ( SELECT count(
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_tempo t ON tb_fat_atendimento_individual.co_dim_tempo = t.co_seq_dim_tempo
             JOIN tb_dim_local_atendimento ON tb_fat_atendimento_individual.co_dim_local_atendimento = tb_dim_local_atendimento.co_seq_dim_local_atendimento
          WHERE p.nu_cns::text = tb_dim_profissional.nu_cns::text AND tb_dim_tempo.nu_ano = t.nu_ano) AS domi_ago,
    ( SELECT count(
                CASE
    ...
    ( SELECT count(
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = tb_dim_profissional.nu_cns::text AND t.nu_ano = tb_dim_tempo.nu_ano) AS atendimento_mar,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = tb_dim_profissional.nu_cns::text AND t.nu_ano = tb_dim_tempo.nu_ano) AS atendimento_abr,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = tb_dim_profissional.nu_cns::text AND t.nu_ano = tb_dim_tempo.nu_ano) AS atendimento_mai,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = tb_dim_profissional.nu_cns::text AND t.nu_ano = tb_dim_tempo.nu_ano) AS atendimento_jun,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = tb_dim_profissional.nu_cns::text AND t.nu_ano = tb_dim_tempo.nu_ano) AS atendimento_jul,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = tb_dim_profissional.nu_cns::text AND t.nu_ano = tb_dim_tempo.nu_ano) AS atendimento_ago,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = tb_dim_profissional.nu_cns::text AND t.nu_ano = tb_dim_tempo.nu_ano) AS atendimento_set,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = tb_dim_profissional.nu_cns::text AND t.nu_ano = tb_dim_tempo.nu_ano) AS atendimento_out,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = tb_dim_profissional.nu_cns::text AND t.nu_ano = tb_dim_tempo.nu_ano) AS atendimento_nov,
    ( SELECT count(
                CASE
           ...
           FROM tb_fat_atendimento_individual
             ...
             JOIN tb_dim_municipio tb_dim_municipio_1 ON tb_fat_atendimento_individual.co_dim_municipio = tb_dim_municipio_1.co_seq_dim_municipio
             JOIN tb_dim_tipo_atendimento ON tb_fat_atendimento_individual.co_dim_tipo_atendimento = tb_dim_tipo_atendimento.co_seq_dim_tipo_atendimento
          WHERE p.nu_cns::text = tb_dim_profissional.nu_cns::text AND t.nu_ano = tb_dim_tempo.nu_ano) AS atendimento_dez,
    ( SELECT count(
                CASE
...
ALTER TABLE pmaq."ATENDIMENTOS_PROFISSIONAL"
  OWNER TO postgres;
GRANT ALL ON TABLE pmaq."ATENDIMENTOS_PROFISSIONAL" TO postgres;
GRANT ALL ON TABLE pmaq."ATENDIMENTOS_PROFISSIONAL" TO pmaq;
