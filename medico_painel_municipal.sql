-- View: pmaq."MEDICO_PAINEL_MUNICIPAL"

DROP VIEW if exists pmaq."MEDICO_PAINEL_MUNICIPAL";

CREATE OR REPLACE VIEW pmaq."MEDICO_PAINEL_MUNICIPAL" AS 
...
ALTER TABLE pmaq."MEDICO_PAINEL_MUNICIPAL"
  OWNER TO postgres;
GRANT ALL ON TABLE pmaq."MEDICO_PAINEL_MUNICIPAL" TO postgres;
GRANT ALL ON TABLE pmaq."MEDICO_PAINEL_MUNICIPAL" TO pmaq;
