-- View: pmaq."ENFERMEIRO_MUNICIPAL"

DROP VIEW if exists pmaq."ENFERMEIRO_MUNICIPAL";

CREATE OR REPLACE VIEW pmaq."ENFERMEIRO_MUNICIPAL" AS 
...
ALTER TABLE pmaq."ENFERMEIRO_MUNICIPAL"
  OWNER TO postgres;
GRANT ALL ON TABLE pmaq."ENFERMEIRO_MUNICIPAL" TO postgres;
GRANT ALL ON TABLE pmaq."ENFERMEIRO_MUNICIPAL" TO pmaq;
