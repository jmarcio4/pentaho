-- View: pmaq."ACS_POR_PESSOA"

 DROP VIEW IF EXISTS pmaq."ACS_POR_PESSOA";

CREATE OR REPLACE VIEW pmaq."ACS_POR_PESSOA" AS 
...
ALTER TABLE pmaq."ACS_POR_PESSOA"
  OWNER TO postgres;
GRANT ALL ON TABLE pmaq."ACS_POR_PESSOA" TO postgres;
GRANT ALL ON TABLE pmaq."ACS_POR_PESSOA" TO pmaq;
